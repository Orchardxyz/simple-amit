...
<DialogPrimitive.Root bind:open>
	<DialogPrimitive.Portal>
		...
		<DialogPrimitive.Content
			class="fixed left-1/2 top-1/2 z-10 w-[min(32rem,calc(100vw-2.5rem))] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg border border-[var(--vscode-panel-border)] bg-[var(--vscode-editorWidget-background)] shadow-2xl outline-none"
		>
